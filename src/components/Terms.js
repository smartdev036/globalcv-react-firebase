...
export default () => {
    return (
        <div className="container">
            ...
            <div>
                <h3>OVERVIEW</h3>
                <p>This website bestcv.org is operated by Wayanad Green Fresh (OPC) Pvt Ltd. Throughout the site, the terms “we”, “us” and “our” refer to Wayanad Green Fresh. Wayanad Green Fresh offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
            ...
            <div>
                ...
                <p>Questions about the Terms of Service should be sent to us at <a href="mailto:contact@wayanadgreenfresh.com">contact@wayanadgreenfresh.com</a>.</p>
            </div>
        </div>
    );
}