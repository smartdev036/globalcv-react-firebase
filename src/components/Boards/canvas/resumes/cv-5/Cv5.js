...
class Cv5 extends Component {
    ...
    render() {
        return <Stage width={470} height={640} ref={node => { this.stageRef = node }}>
            ...
            <Group>
                {/* Background rects */}
                <Rect width={180} height={640} fill="#d0cecf"></Rect>
                <Rect width={390} height={640} fill="#FFF" x={180}></Rect>
            </Group>
            <Group ref={node => { this.headRef = node }} >
                {/* First Name & SurName */}
                <Text width={180} align = 'center' fontFamily="Poppins" fontStyle="bold" text={this.props.values.firstname} y={45}                     fontSize={20} ref={node => { this.firstnameRef = node }} />
                <Text width={180} align = 'center' fontFamily="Poppins" fontStyle="bold" text={this.props.values.lastname} y={75} fontSize={20} ref={node => { this.lastnameRef = node }} fill = '#EE7727' /> 
                {this.props.values.photo != null ?
                    <Image x={0} y={105} height={120} width={180} image={this.props.values.photo} ></Image> : 
                    <Group>
                        {/* Image Rect */}
                        <Rect stroke="#080808" height={120} width={180} x={0} y={105} strokeWidth={1} />
                        <Text width={40} height={20} fontFamily="Poppins" fontStyle="bold" text={"photo"} fontSize={11} y={160} x={75}  />
                    </Group>
                }
            </Group>
